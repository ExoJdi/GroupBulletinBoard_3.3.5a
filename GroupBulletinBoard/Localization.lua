...
GBB.locales = {
  enGB = {
    ...
    ["msgNbRequest"] = "%d request(s) | Click: whisper | Shift: who | Ctrl: invite | Alt: send template (GS+spec)",
    ...
    ["normalAbr"] = "N",
    ["raidAbr"] = "R",
    ["msgFontFace"] = "Font (Requires /reload)",
    ["msgFontSize"] = "Font Size",
    ...
    ["CboxDonttruncate"] = "Don't truncate message",
  ...
  deDE = {
    ...
    ["CboxDonttruncate"] = "Nachricht nicht abkürzen",
  ...
  ruRU = {
    ...
    ["CboxDonttruncate"] = "Не обрезать сообщения",
    ...
    ["msgNbRequest"] = "%d запрос(ов) | ЛКМ: шёпот | Shift: /кто | Ctrl: инвайт | Alt: шаблон (GS+спек)",
