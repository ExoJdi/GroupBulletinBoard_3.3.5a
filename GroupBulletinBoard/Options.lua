...
function GBB.OptionsUpdate()
  ...
  -- Members tab removed: no tab management needed
...
function SetChatOption()
  ...
  for i = 1, 10 do
    ...
    elseif i == 8 then
      GBB.Options.AddCheckBox(GBB.DBChar, "yellEnabled", true, "18. Yell (/y)")
    elseif i == 9 then
      GBB.Options.AddCheckBox(GBB.DBChar, "emoteEnabled", true, "19. Emote (/e)")
    elseif i == 10 then
      GBB.Options.AddCheckBox(GBB.DBChar.channel, 20, true, "20. Guild")
    end
...
function GBB.OptionsInit()
  ...
  -- Font face selection using LibSharedMedia
  GBB.Options.AddText(GBB.L["msgFontFace"], -20)
  local LSM = LibStub("LibSharedMedia-3.0")
  local fonts = LSM:List("font")
  GBB.Options.AddDropScroll(GBB.DB, "fontFace", GBB.DB.fontFace, fonts)

  -- Font size slider
  GBB.Options.AddText(GBB.L["msgFontSize"], -20)
  GBB.Options.AddSlider(GBB.DB, "fontSize", GBB.DB.fontSize, 8, 72, 1)
